...
const MENU_ITEMS = [
  { name: 'Plain Fries', price: 115, index: 0, note: 'Crispy golden fries.' },
  { name: 'Rib Crib Salad', price: 325, index: 1, note: 'Fresh, bright, and made for sharing.' },
  { name: 'Sisig Tacos', price: 225, index: 2, note: 'Savory sisig tucked into crisp tacos.' },
  { name: '6 pcs. Chicken Wings', price: 245, index: 3, note: 'Choose from bold Rib Crib flavors.' },
  { name: '2 pcs. Barbecue Ribs', price: 395, index: 4, note: 'Smoky barbecue ribs, glazed and tender.' },
  { name: 'Unlimited Wings', price: 325, index: 5, note: 'Includes rice and iced tea.' },
  { name: 'Juice', price: 55, index: 6, note: 'A cold drink for the feast.' },
  { name: 'Iced Tea', price: 25, index: 7, note: 'Glass.' },
];

const PLATTERS = [
  { name: 'Rib Crib Platter', price: 875, index: 0, note: 'Wings, calamares, dynamites, fries + rice.' },
  { name: 'Rib Crib Platter with Ribs', price: 1045, index: 1, note: 'A sharing platter with ribs and rice.' },
  { name: 'Barkada Platter', price: 1520, index: 2, note: 'Wings, BBQ ribs, calamares, fries + rice.' },
  { name: 'BBQ Ribs Platter', price: 2225, index: 3, note: 'Built around the Rib Crib ribs.' },
  { name: 'Mega Platter', price: 2950, index: 4, note: 'The biggest spread for a hungry group.' },
];
    ...
    <div className="rib-crib-page">
      ...
      <section className="rib-hero" aria-labelledby="rib-hero-title">
        ...
        <div className="rib-hero-copy">
          <img className="rib-hero-emblem" src="/rib-crib/emblem.webp" alt="The Rib Crib — Let’s Meat Here, established 2018" />
          ...
          {MENU_ITEMS.map((item, position) => (
            <article className="rib-menu-card" key={item.name} style={{ '--rib-delay': `${position * 45}ms` } as React.CSSProperties}>
              <div
                ...
                style={{
                  backgroundImage: "url('/rib-crib/menu-sprite.webp')",
                  backgroundSize: '800% 100%',
                  backgroundPosition: `${(item.index / 7) * 100}% center`,
                }}
                aria-hidden
              />
          ...
          {PLATTERS.map((item, position) => (
            <article className="rib-platter-card" key={item.name} style={{ '--rib-delay': `${position * 60}ms` } as React.CSSProperties}>
              <div
                ...
                style={{
                  backgroundImage: "url('/rib-crib/platter-sprite.webp')",
                  backgroundSize: '500% 100%',
                  backgroundPosition: `${(item.index / 4) * 100}% center`,
                }}
                aria-hidden
              />
      ...
      <footer className="rib-footer">
        <div className="rib-footer-brand"><img src="/rib-crib/emblem.webp" alt="" aria-hidden /><div><strong>The Rib Crib</strong><span>Eat Meat Repeat</span></div></div>
