  ...
  return <div className={styles.root} data-wild-tree="true">
    <header className={styles.header} onKeyDown={event => { if (event.key === 'Escape' && navOpen) { closeNav(); navRef.current?.focus(); } }}>
      <div className={styles.headerInner}>
        <a href="#wild-tree-top" className={styles.logo} aria-label="The Wild Tree, back to top" onClick={closeNav}><Photo src={assets.logoLight} fallbackSrc={assets.logoLightFallback} alt="The Wild Tree" width={379} height={192} loading="eager" fetchPriority="high" /></a>
