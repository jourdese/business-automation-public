...
- Review the compact Menu tile behavior locally: the grid should never resize; clicking a tile should open a compact modal with a thumbnail-sized image, quick KPIs/actions first, and deeper reference/ingredient information under `More details`.
