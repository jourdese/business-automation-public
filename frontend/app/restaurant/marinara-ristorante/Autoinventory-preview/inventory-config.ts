...
export const initialIngredients: Ingredient[] = [
  { id: "pasta", name: "Pasta", unit: "kg", current: 10.2, fullLevel: 12, reorderAt: 4, dailyUse: 1.7, incoming: 0, supplierId: "davao-provisions", contactId: "paolo", packSize: 5, packPrice: 860, purchaseUnit: "5 kg case", leadDays: 1, purchasingMode: "fixed", automationEnabled: false, automationMode: "auto_contact", targetPackPrice: 860, autoAcceptPackPrice: 900, hardMaxPackPrice: 950, maxAutoOrderQty: 15, maxAutoOrderSpend: 5000, autoNegotiate: false, maxCounteroffers: 0, maxDeliveryFee: 250, maxLeadDays: 2, automationPreview: true, zone: "Pantry" },
  { id: "tomato", name: "Tomato sauce", unit: "L", current: 7.4, fullLevel: 10, reorderAt: 3, dailyUse: 1.45, incoming: 0, supplierId: "casa-rosso", contactId: "lia", packSize: 4, packPrice: 980, purchaseUnit: "4 L case", leadDays: 1, purchasingMode: "fixed", automationEnabled: false, automationMode: "auto_contact", targetPackPrice: 980, autoAcceptPackPrice: 1030, hardMaxPackPrice: 1080, maxAutoOrderQty: 12, maxAutoOrderSpend: 5000, autoNegotiate: false, maxCounteroffers: 0, maxDeliveryFee: 250, maxLeadDays: 2, automationPreview: true, zone: "Pantry" },
  { id: "olive-oil", name: "Olive oil", unit: "L", current: 4.5, fullLevel: 5, reorderAt: 1.5, dailyUse: 0.38, incoming: 0, supplierId: "casa-rosso", contactId: "lia", packSize: 2, packPrice: 1220, purchaseUnit: "2 L case", leadDays: 2, purchasingMode: "fixed", automationEnabled: false, automationMode: "auto_contact", targetPackPrice: 1220, autoAcceptPackPrice: 1280, hardMaxPackPrice: 1350, maxAutoOrderQty: 6, maxAutoOrderSpend: 5000, autoNegotiate: false, maxCounteroffers: 0, maxDeliveryFee: 250, maxLeadDays: 3, automationPreview: true, zone: "Pantry" },
  { id: "flour", name: "Pizza flour", unit: "kg", current: 13, fullLevel: 15, reorderAt: 5, dailyUse: 2.1, incoming: 0, supplierId: "davao-provisions", contactId: "paolo", packSize: 10, packPrice: 760, purchaseUnit: "10 kg sack", leadDays: 1, purchasingMode: "fixed", automationEnabled: false, automationMode: "auto_contact", targetPackPrice: 760, autoAcceptPackPrice: 800, hardMaxPackPrice: 850, maxAutoOrderQty: 30, maxAutoOrderSpend: 5000, autoNegotiate: false, maxCounteroffers: 0, maxDeliveryFee: 250, maxLeadDays: 2, automationPreview: true, zone: "Pantry" },
  { id: "parmesan", name: "Parmigiano", unit: "kg", current: 1.45, fullLevel: 5, reorderAt: 2, dailyUse: 0.62, incoming: 0, supplierId: "italian-pantry", contactId: "marco", packSize: 2, packPrice: 2380, purchaseUnit: "2 kg wheel", leadDays: 2, purchasingMode: "fixed", automationEnabled: false, automationMode: "auto_contact", targetPackPrice: 2380, autoAcceptPackPrice: 2500, hardMaxPackPrice: 2650, maxAutoOrderQty: 6, maxAutoOrderSpend: 7000, autoNegotiate: false, maxCounteroffers: 0, maxDeliveryFee: 300, maxLeadDays: 3, automationPreview: true, zone: "Cold storage" },
  { id: "mozzarella", name: "Mozzarella", unit: "kg", current: 6.1, fullLevel: 8, reorderAt: 3, dailyUse: 1.15, incoming: 0, supplierId: "italian-pantry", contactId: "marco", packSize: 3, packPrice: 1650, purchaseUnit: "3 kg case", leadDays: 1, purchasingMode: "fixed", automationEnabled: false, automationMode: "auto_contact", targetPackPrice: 1650, autoAcceptPackPrice: 1750, hardMaxPackPrice: 1850, maxAutoOrderQty: 9, maxAutoOrderSpend: 7000, autoNegotiate: false, maxCounteroffers: 0, maxDeliveryFee: 300, maxLeadDays: 2, automationPreview: true, zone: "Cold storage" },
  { id: "cream", name: "Cooking cream", unit: "L", current: 2.25, fullLevel: 5, reorderAt: 2, dailyUse: 0.72, incoming: 0, supplierId: "davao-dairy", contactId: "anne", packSize: 2, packPrice: 720, purchaseUnit: "2 L case", leadDays: 1, purchasingMode: "fixed", automationEnabled: false, automationMode: "auto_contact", targetPackPrice: 720, autoAcceptPackPrice: 760, hardMaxPackPrice: 800, maxAutoOrderQty: 6, maxAutoOrderSpend: 4000, autoNegotiate: false, maxCounteroffers: 0, maxDeliveryFee: 250, maxLeadDays: 2, automationPreview: true, zone: "Cold storage" },
  { id: "shrimp", name: "Shrimp", unit: "kg", current: 2.2, fullLevel: 10, reorderAt: 3, dailyUse: 1.95, incoming: 0, supplierId: "davao-seafood", contactId: "maria", packSize: 5, packPrice: 2800, purchaseUnit: "5 kg pack", leadDays: 1, purchasingMode: "quote", automationEnabled: false, automationMode: "autobuy", targetPackPrice: 2800, autoAcceptPackPrice: 2950, hardMaxPackPrice: 3100, maxAutoOrderQty: 15, maxAutoOrderSpend: 10000, autoNegotiate: true, maxCounteroffers: 2, maxDeliveryFee: 300, maxLeadDays: 2, automationPreview: true, zone: "Seafood freezer" },
  { id: "salmon", name: "Salmon", unit: "kg", current: 4.9, fullLevel: 8, reorderAt: 3, dailyUse: 1.05, incoming: 0, supplierId: "davao-seafood", contactId: "maria", packSize: 4, packPrice: 3440, purchaseUnit: "4 kg case", leadDays: 1, purchasingMode: "quote", automationEnabled: false, automationMode: "autobuy", targetPackPrice: 3440, autoAcceptPackPrice: 3600, hardMaxPackPrice: 3800, maxAutoOrderQty: 12, maxAutoOrderSpend: 12000, autoNegotiate: true, maxCounteroffers: 2, maxDeliveryFee: 300, maxLeadDays: 2, automationPreview: true, zone: "Seafood freezer" },
  { id: "squid", name: "Squid", unit: "kg", current: 1.7, fullLevel: 6, reorderAt: 2.2, dailyUse: 1, incoming: 0, supplierId: "davao-seafood", contactId: "maria", packSize: 3, packPrice: 1380, purchaseUnit: "3 kg pack", leadDays: 1, purchasingMode: "quote", automationEnabled: false, automationMode: "autobuy", targetPackPrice: 1380, autoAcceptPackPrice: 1450, hardMaxPackPrice: 1550, maxAutoOrderQty: 9, maxAutoOrderSpend: 7000, autoNegotiate: true, maxCounteroffers: 2, maxDeliveryFee: 300, maxLeadDays: 2, automationPreview: true, zone: "Seafood freezer" },
  { id: "basil", name: "Fresh basil", unit: "kg", current: 0.48, fullLevel: 2, reorderAt: 0.7, dailyUse: 0.31, incoming: 0, supplierId: "green-basket", contactId: "mika", packSize: 1, packPrice: 410, purchaseUnit: "1 kg bundle", leadDays: 0.5, purchasingMode: "quote", automationEnabled: false, automationMode: "autobuy", targetPackPrice: 410, autoAcceptPackPrice: 440, hardMaxPackPrice: 470, maxAutoOrderQty: 3, maxAutoOrderSpend: 2500, autoNegotiate: true, maxCounteroffers: 1, maxDeliveryFee: 200, maxLeadDays: 1, automationPreview: true, zone: "Produce" },
  { id: "mushroom", name: "Mushrooms", unit: "kg", current: 2.8, fullLevel: 5, reorderAt: 1.8, dailyUse: 0.74, incoming: 0, supplierId: "green-basket", contactId: "mika", packSize: 2, packPrice: 540, purchaseUnit: "2 kg crate", leadDays: 0.5, purchasingMode: "quote", automationEnabled: false, automationMode: "autobuy", targetPackPrice: 540, autoAcceptPackPrice: 570, hardMaxPackPrice: 620, maxAutoOrderQty: 6, maxAutoOrderSpend: 3500, autoNegotiate: true, maxCounteroffers: 1, maxDeliveryFee: 200, maxLeadDays: 1, automationPreview: true, zone: "Produce" },
];
